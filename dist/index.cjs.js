...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f61f2e", backgroundDisabled: "#f6612e", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#f61f2e", tertiary: "#4746cd", text: "#4746cd", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", borderColor: "#4746cd", card: "#FFFFFF", gradients: {
